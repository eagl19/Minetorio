...
import net.eagl.minetorio.entity.ai.RhinoAttackGoal;
...
public class RhinoEntity extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new TemptGoal(this, 1.2D, Ingredient.of(MinetorioItems.CORN.get()), false));
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel pLevel, @NotNull AgeableMob pOtherParent) {
        return MinetorioEntities.RHINO.get().create(pLevel);
    }

    @Override
    public boolean isFood(ItemStack pStack) {
        return pStack.is(MinetorioItems.CORN.get());
    }
