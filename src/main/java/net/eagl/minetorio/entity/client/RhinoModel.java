...
import net.eagl.minetorio.entity.animations.MinetorioAnimationDefinitions;
...
public class RhinoModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public void setupAnim(@NotNull T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(MinetorioAnimationDefinitions.RHINO_WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
        this.animate(((RhinoEntity) entity).idleAnimationState, MinetorioAnimationDefinitions.RHINO_IDLE, ageInTicks, 1f);
        this.animate(((RhinoEntity) entity).attackAnimationState, MinetorioAnimationDefinitions.RHINO_ATTACK, ageInTicks, 1f);
    }
