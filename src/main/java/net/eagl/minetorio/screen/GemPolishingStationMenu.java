package net.eagl.minetorio.screen;

import net.eagl.minetorio.block.entity.GemPolishingStationBlockEntity;
...
public class GemPolishingStationMenu extends AbstractContainerMenu {
    ...
    public GemPolishingStationMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(MinetorioMenuTypes.GEM_POLISHING_MENU.get(), pContainerId);
    ...
    public boolean stillValid(@NotNull Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, MinetorioBlocks.GEM_POLISHING_STATION.get());
    }
