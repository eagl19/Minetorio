...
public class MinetorioBlockTagGenerator extends BlockTagsProvider {
    public MinetorioBlockTagGenerator(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, @Nullable ExistingFileHelper existingFileHelper) {
    ...
    protected void addTags(HolderLookup.@NotNull Provider pProvider) {
        ...
        this.tag(BlockTags.FENCES)
                .add(MinetorioBlocks.SAPPHIRE_FENCE.get());
        this.tag(BlockTags.FENCE_GATES)
                .add(MinetorioBlocks.SAPPHIRE_FENCE_GATE.get());
        this.tag(BlockTags.WALLS)
                .add(MinetorioBlocks.SAPPHIRE_WALL.get());
