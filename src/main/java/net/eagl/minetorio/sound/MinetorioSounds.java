package net.eagl.minetorio.sound;
...
public class MinetorioSounds {
    ...
    public static final ForgeSoundType SOUND_BLOCK_SOUNDS = new ForgeSoundType(1f, 1f,
            MinetorioSounds.SOUND_BLOCK_BREAK, MinetorioSounds.SOUND_BLOCK_STEP, MinetorioSounds.SOUND_BLOCK_PLACE,
            MinetorioSounds.SOUND_BLOCK_HIT, MinetorioSounds.SOUND_BLOCK_FALL);


    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(Minetorio.resourceLocation(name)));
    }
